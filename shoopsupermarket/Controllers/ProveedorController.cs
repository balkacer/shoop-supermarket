...
namespace shoopsupermarket.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PROV_ID,NAME,PHONE1,PHONE2")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PROV_ID,NAME,PHONE1,PHONE2")] Proveedor proveedor)
        {
        ...
        {
            return _context.Proveedores.Any(e => e.PROV_ID == id);
        }
    }
}
